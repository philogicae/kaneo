...
4. Optionally set description, assignee, priority, due date, and labels. Depending on the installation, the priority and labels may be suggested automatically from the title and description; review what was applied and adjust if needed.
