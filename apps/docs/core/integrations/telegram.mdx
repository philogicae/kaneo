...
| Mentions in task body or comments | On | A task description or comment @mentions a workspace member |

You can change these toggles at any time in the integration settings.

## Unified notification config

Beyond the per-project integration below, Settings → Account → Notifications →
Telegram offers a
