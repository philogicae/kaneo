...
You can also reach the same per-project settings from **Settings → Account → Notifications → Slack**: the tab lists every project's integration status and opens this form inline.
